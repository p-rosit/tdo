...
@pytest.mark.skipif(os.name != 'nt', reason='Does not run on non-windows system')
def test_CreateFile_fails(temp_directory: str, root_directory: str, runner: Runner, library: str, run_tests, amount: int):
...
@pytest.mark.skipif(os.name != 'nt', reason='Does not run on non-windows system')
def test_CreateIoCompletionPort_setup_fails(temp_directory: str, root_directory: str, runner: Runner, library: str, run_tests):
...
@pytest.mark.skipif(os.name != 'nt', reason='Does not run on non-windows system')
def test_CreateJobObject_fails(temp_directory: str, root_directory: str, runner: Runner, library: str, run_tests):
...
@pytest.mark.skipif(os.name != 'nt', reason='Does not run on non-windows system')
def test_GetModuleFileName_fails(temp_directory: str, root_directory: str, runner: Runner, library: str, run_tests):
